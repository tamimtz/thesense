...
<div class="jumbotron-fluid p-5">
    ...
    <p class="jumbo">All in 1 Community For Your Gaming needs.</p>
    <ul class="nav nav-pills">
        <li class="nav-item">
          <a class="pills" aria-current="page" href="#">Gaming</a>
        </li>
        <li class="nav-item">
          <a class="pills " href="#">Anime</a>
        </li>
        <li class="nav-item">
          <a class="pills" href="#">Trading</a>
        </li>
        <li class="nav-item">
          <a class="pills" href="#" tabindex="-1" aria-disabled="true">Community</a>
        </li>
    </ul>
    <br>
    <br>
    <p class="lead">
      <a class="home-login" href="#" role="button">Join Us</a>
    </p>
  ...
  <div class="row justify-content-evenly">
    <div class="news-home col-4 ">
      ...
      <p class="text-light">“Any single piece of content would be more valuable when bundled as part of the Battle Pass, so we bundled more and more,” Valve wrote in its announcement. “This led to a momentous content drop every year, but it also greatly limited our ability to do things that were exciting and valuable for players but didn’t fit into the Battle Pass reward line.”
        ...
        You can read the full blog post about the future of the Dota 2 Battle Pass from Valve here.</p>
    </div>
    <div class="col-4">
      <p class="jumbo"> For The Chad Gohan</p>
      <iframe width="720" height="406" src="https://www.youtube.com/embed/nDw91poHomA?list=RDnDw91poHomA" title="Dragon Ball Z - Gohan&#39;s Anger [Epic Orchestral Cover]" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </div>
  </div>
</div>
