...
<div class="container alert alert-transparent  text-dark">
<h3 class="bg-transparent text-light">Hello,  {{ $user != null ? $user->name : ""}}</h3>
</div>
    ...
    <div class="container posts">
        <div class="row">
            ...
            <div class="card card-custom-background mb-3" style="width: 20rem">
                <img src="{{ url('/storage/images/'.$post->file) }}" class="img-thumbnail m-3" alt="..." >
                <div class="card-body">
                  <h5 class="card-title">{{ $post->title }}</h5>
                  <p class="card-text">{{ substr($post->content, 0, 200) }} <a class="card-custom-background-link" href="{{ route('post.show', $post->id) }}">... Show More</a></p>
